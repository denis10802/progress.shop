                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    ...
                                    <input type="text" name="retail" class="form-control" id="price-1" placeholder="Розница">
                                </div>
                                <div class="col-4">
                                    <label for="price-2">Оптовая цена</label>
                                    <input type="text" name="wholesale" class="form-control" id="price-2" placeholder="Опт">
                                </div>
                            </div>
                        </div>
                        </div>
