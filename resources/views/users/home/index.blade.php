...
@section('content')
    ...
    <div class="job-location section pt-110 bg-image-proparty bg_image--2 pt-lg-95 pt-md-75 pt-sm-55 pt-xs-45 pb-120 pb-lg-100 pb-md-80 pb-sm-60 pb-xs-50">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title-wrap mb-45">
                        ...
                        <div class="jetapo-link">
                            <a href="index.html#">Browse All Locations <i class="lnr lnr-chevron-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="section-title-wrap mb-45">
                        ...
                        <div class="jetapo-tab-menu">
                            <ul class="nav">
                                <li><a class="active show" data-toggle="tab" href="index.html#fullTime"> Full Time </a></li>
                                <li><a data-toggle="tab" href="index.html#partTime"> Part Time </a></li>
                                <li><a data-toggle="tab" href="index.html#remote"> Remote </a></li>
                                <li><a data-toggle="tab" href="index.html#freelancer"> Freelancer </a></li>
                                <li><a data-toggle="tab" href="index.html#internship"> Internship </a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="info-top">
                                            ...
                                            <div class="job-info">
                                                <div class="job-info-inner">
                                                    ...
                                                    <div class="job-meta">
                                                        <div class="job-location"><i class="lnr lnr-map-marker"></i><a href="index.html#">Houston</a></div>

                                                        <div class="job-type"><i class="lnr lnr-briefcase"></i><a class="def-color" href="index.html#">Full Time</a></div>

                                                        <div class="job-date"><i class="lnr lnr-clock"></i>Sep 12, 2019</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="info-top">
                                            ...
                                            <div class="job-info">
                                                <div class="job-info-inner">
                                                    ...
                                                    <div class="job-meta">
                                                        <div class="job-location"><i class="lnr lnr-map-marker"></i><a href="index.html#">New York</a></div>

                                                        <div class="job-type"><i class="lnr lnr-briefcase"></i><a class="def-color" href="index.html#">Full Time</a></div>

                                                        <div class="job-date"><i class="lnr lnr-clock"></i>Sep 12, 2020</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="info-top">
                                            ...
                                            <div class="job-info">
                                                <div class="job-info-inner">
                                                    ...
                                                    <div class="job-meta">
                                                        <div class="job-location"><i class="lnr lnr-map-marker"></i><a href="index.html#">Los Angeles</a></div>
