            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about-content">
                        ...
                        <p class="normal-text">  Мы предлагаем своим клиентам полный спектр отечественных и зарубежных материалов и оборудования, которые прошли успешную апробацию на практике и  надежность которых мы можем гарантировать.   Вся поставляемая нашей фирмой продукция имеет сертификаты ISO 9000, надлежащие сертификаты безопасности и полностью соответствует отечественным нормативам.</p>
                    </div>
                </div>
            </div>
        </div>
