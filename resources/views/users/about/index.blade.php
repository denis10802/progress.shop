...
@section('content')
    ...
    <div class="page-banner-section section">
        <div class="banner-image">
            <img src="/users/images/about/bg-top-about-us.jpg" alt="">
        </div>
    </div>
    ...
    <div class="company-history-section section pt-110 pt-lg-90 pt-md-70 pt-sm-50 pt-xs-40 pb-60 pb-lg-40 pb-md-20 pb-sm-0 pb-xs-45">
        <div class="container">
            ...
            <div class="action">
                <a href="about.html#" data-slide="1">2009</a>
                <a href="about.html#" data-slide="2">2010</a>
                <a href="about.html#" data-slide="3">2011</a>
                <a href="about.html#" data-slide="4">2014</a>
                <a href="about.html#" data-slide="5">2015</a>
                <a href="about.html#" data-slide="6">2016</a>
                <a class="mr-0" href="about.html#" data-slide="7">2017</a>
            </div>
        </div>
    </div>
    <!-- Company History Section Start -->
                ...
                <div class="col-12">
                    <div class="about-video-popup">
                        ...
                        <div class="video-popup-content d-flex justify-content-center">
                            <a class="link-video venobox d-flex" data-autoplay="true" data-vbtype="video" href="https://www.youtube.com/watch?v=XSGBVzeBUbk">
            ...
            <div class="row no-gutters border-top-left">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="single-team team-style-two">
                        ...
                        <div class="team-content">
                            <h4 class="team-title">
                                <a href="about.html#">Sidney Wilcox</a>
                            </h4>
                        ...
                        <div class="item-box transition-theme">
                            <div class="team-info-social">
                                <ul class="social-link-hover">
                                    <li><a class="facebook" href="about.html#"><i class="fab fa-facebook-square"></i></a></li>
                                    <li><a class="twitter" href="about.html#"><i class="fab fa-twitter"></i></a></li>
                                    <li><a class="google-plus" href="about.html#"><i class="fab fa-google-plus-g"></i></a></li>
                                    <li><a class="youtube" href="about.html#"><i class="fab fa-youtube"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="single-team team-style-two">
                        ...
                        <div class="team-content">
                            <h4 class="team-title">
                                <a href="about.html#">Nora Buchanan </a>
                            </h4>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="single-team team-style-two">
                        ...
                        <div class="team-content">
                            <h4 class="team-title">
                                <a href="about.html#">Jenny Hobbs </a>
                            </h4>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="single-team team-style-two">
                        ...
                        <div class="team-content">
                            <h4 class="team-title">
                                <a href="about.html#">Daniel Nguyen </a>
                            </h4>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <div class="single-team team-style-two">
                        ...
                        <div class="team-content">
                            <h4 class="team-title">
                                <a href="about.html#">Pamela Hood</a>
                            </h4>
